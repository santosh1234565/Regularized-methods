...
#saving the output
capture.output(summary(res), file = "withoutTA30.txt", append = TRUE)
capture.output(coeff, file = "withoutTA30.txt", append = TRUE)
capture.output(varalasso, file = "withoutTA30.txt", append = TRUE)
